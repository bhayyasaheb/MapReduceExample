...
/*
 * GrossProfitPercentByProduct
 */

public class GrossProfitPercentByProduct {

	public static class GrossMapper  extends Mapper< LongWritable, Text, Text, Text>
	{
	...
	public static class GrossReducer extends Reducer<Text, Text, Text, Text>
	{
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(GrossProfitPercentByProduct.class);
		job.setMapperClass(GrossMapper.class);
		job.setReducerClass(GrossReducer.class);
