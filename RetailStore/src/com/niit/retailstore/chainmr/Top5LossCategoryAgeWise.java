...
public class Top5LossCategoryAgeWise {
			...
			// saving category and age to myKey here key is category with \t as delimiter
			 ...
			 if(loss > 0)
			 {
				// writing reducer output when loss is +ve  
				 // key is difference between cost-sales and value is category and age as Reducer output
	...
	public static class SortMapper extends Mapper<LongWritable, Text, DoubleWritable, Text>
	{
		...
		protected void map(LongWritable key, Text value,Context context)throws IOException, InterruptedException 
		{
			...
			// Mapper output key is loss and output value is category and age
	...
	public static class SortReducer extends Reducer<DoubleWritable, Text, Text, DoubleWritable>
	{
		...
		protected void reduce(DoubleWritable key, Iterable<Text> values,Context context)throws IOException, InterruptedException
		{
			if(count < 5)
			{
				for(Text val :values)
				{
					// Reducer output key is category & age and output value is loss
	...
	public static void main(String[] args) throws Exception {
		...
		Job job1 = Job.getInstance(conf,"Using Chain MR Top 5 loss making Category Age wise");
		
		job1.setJarByClass(Top5LossCategoryAgeWise.class);
		...
		Path outputPath1 = new Path("FirstMapper4"); // This will be stored in hdfs like /user/hduser/FirstMapper4
		...
		Job job2 = Job.getInstance(conf,"Using Chain MR Top 5 loss making Category Age wise");
		
		job2.setJarByClass(Top5LossCategoryAgeWise.class);
