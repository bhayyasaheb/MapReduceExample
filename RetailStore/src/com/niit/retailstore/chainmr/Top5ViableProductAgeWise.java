...
public class Top5ViableProductAgeWise {
	...
	public static class FirstReducer extends Reducer<Text, Text, LongWritable, Text>
	{
		...
		protected void reduce(Text key, Iterable<Text> values,Context context)throws IOException, InterruptedException 
		{
			 ...
			 if(viable > 0)
			 {
				 ...
				 // key is difference between sales - cost and value is product and age as Reducer output
	...
	public static class SortMapper extends Mapper<LongWritable, Text, DoubleWritable, Text>
	{
		...
		protected void map(LongWritable key, Text value,Context context)throws IOException, InterruptedException 
		{
			...
			// Mapper output key is viable and output value is product and age
	...
	public static class SortReducer extends Reducer<DoubleWritable, Text, Text, DoubleWritable>
	{
		...
		protected void reduce(DoubleWritable key, Iterable<Text> values,Context context)throws IOException, InterruptedException
		{
			if(count < 5)
			{
				for(Text val :values)
				{
					// Reducer output key is product & age and output value is viable
	...
	public static void main(String[] args) throws Exception {
		...
		Job job1 = Job.getInstance(conf,"Using Chain MR Top 5 Viable Product Age wise");
		
		job1.setJarByClass(Top5ViableProductAgeWise.class);
		...
		Path outputPath1 = new Path("FirstMapper1"); // This will be stored in hdfs like /user/hduser/FirstMapper1
		...
		Job job2 = Job.getInstance(conf,"Using Chain MR Top 5 Viable Product Age wise");
		
		job2.setJarByClass(Top5ViableProductAgeWise.class);
