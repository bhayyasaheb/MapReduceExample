...
public class ImageDuplicatesMapper extends Mapper<Text, BytesWritable, Text, Text>{
	...
	protected void map(Text key, BytesWritable value,Context context)throws IOException, InterruptedException 
	{
		...
		// be grouped together for reduce function
		
		context.write(md5Text, key);
	}
	
	public static String calculateMd5(byte[] imageData) throws NoSuchAlgorithmException
	{
		...
		// Below code to converting Byte Array to hex
